...
namespace AlgoOpp.Controllers.Company
{
    public class RecruitmentController : Controller
    {
        ...
        private TechathonDB_user11Entities2 dbcompany = new TechathonDB_user11Entities2();
        // GET: Recruitment
        ...
        public ActionResult Create(/*[Bind(Include = "RECRUIT_ID,POSITION,JOB_LOCATION,SKILLS_REQ,JOB_DESC,REQ_CGPA,CREATED_DATE,CREATED_BY,MODIFIED_DATE,MODIFIED_BY,EST_ID")]*/ RECRUITMENT rECRUITMENT,COMPANY_DETAILS company)
        {
